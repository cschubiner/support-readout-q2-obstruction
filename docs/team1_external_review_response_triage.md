...
3. Local probe measurements: do the induced Fewster-Verch probe effects
   separate the finite central contrasts, or can they still factor through a
   quotient/retraction?
4. DHR/DR sector reconstruction: does the supplied superselection structure
   retain finite central-character fibers, or only the restricted category?
5. OAQEC/JLMS/black-hole algebra: do recovery/relative entropy theorems imply
   maximality of the supplied algebra, or only recovery inside it?
6. Crossed-product entropy: does the gravitational Type II construction supply
   finite central trace/area calibration, or only entropy for a specified
   algebra and trace normalization?
7. Discrete black-hole spectroscopy: does a standard area-quantization or
...
8. Positive accountability: the finite accountability quotient is internally
