...
The proposition is narrow.  It says that the RCE-defined equality of
kinematic and dynamical local subobjects does not by itself remove a constant
finite center.  Stronger physical assumptions can remove it:
